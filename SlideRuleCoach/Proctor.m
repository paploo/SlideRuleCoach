...
- (NSArray *)buildExamRegistry {
    ...
    NSArray *trigExams = [NSArray arrayWithObjects:@"AngleConversionExam", @"ArcMinuteConversionExam", @"TrigonometricFunctionsExam", @"InverseTrigonometricFunctionsExam", nil];
